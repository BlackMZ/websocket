...
public class TokenUtil {
     ...
     * token有效期
     */
    private static final long TTL_MILLIS = 36000000;
     ...
     * @return token
     */
    public static String of(String id, Long ttlMillis) {
     ...
     * @return token String
     */
    public static String of(String id, String issuer, String subject, Long ttlMillis) {
        if (ttlMillis == null) {
